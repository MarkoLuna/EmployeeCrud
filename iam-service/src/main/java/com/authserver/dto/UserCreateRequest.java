...
public class UserCreateRequest {
    ...
    @Schema(description = "Username for the new user", example = "jdoe", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Whether the user's email is verified", example = "false", defaultValue = "false")
    private boolean emailVerified = false;
    
    @Schema(description = "List of realm roles to assign", example = "[\"user\"]")
    private List<String> realmRoles;
    
    @Schema(description = "List of client roles to assign")
